...
alert-level-sierra = Sierra
alert-level-sierra-announcement = Central Command has ordered a complete lockdown of the station. All personnel must go to their department. Security personnel are allowed to use lethal weapons.
alert-level-sierra-instructions = All personnel must go to their department.
alert-level-enigma = Enigma
alert-level-enigma-announcement = A containment breach of the singularity, supermatter, or Tesla engine has been detected. The entire crew must immediately evacuate the station by any means necessary. Evacuation by supply and security shuttles has been authorized, and an evacuation is being ordered.
alert-level-enigma-instructions = Security has been ordered to operate under Enigma protocol. Crew members are required to listen to department heads for additional information. Your health and safety depend on it.
