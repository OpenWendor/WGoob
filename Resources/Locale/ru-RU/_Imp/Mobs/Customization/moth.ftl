...
marking-WingsPyrausta = Крылья (Огненная моль)
marking-WingsPyrausta-pyr_neck = Шея
marking-WingsPyrausta-pyr_wing_front = Крылья
marking-WingsPyrausta-pyr_inner_front = Внутреннее крыло
marking-WingsPyrausta-pyr_stripes_front = Полосы
