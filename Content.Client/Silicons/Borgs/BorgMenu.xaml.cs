...
public sealed partial class BorgMenu : FancyWindow
{
    ...
    // erida edit
    public Action? AtmosMonitorButtonPressed;
    public Action? PowerMonitorButtonPressed;
    // erida edit end
    ...
    public BorgMenu()
    {
        ...
        // erida edit
        AtmosMonitorButton.OnPressed += _ => AtmosMonitorButtonPressed?.Invoke();
        PowerMonitorButton.OnPressed += _ => PowerMonitorButtonPressed?.Invoke();
        // erida edit end
    ...
    // erida edit
    public void UpdateMonitorButtons()
    {
        ...
        {
            if (_entity.System<TagSystem>().HasTag(module, "BorgModuleEngineering"))
            {
                isEngineer = true;
                break;
            }
        ...
        AtmosMonitorButton.Visible = isEngineer;
        PowerMonitorButton.Visible = isEngineer;
    }
    // erida edit end
